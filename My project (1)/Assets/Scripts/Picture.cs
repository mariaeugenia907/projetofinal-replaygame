...
public class Picture : MonoBehaviour
{
    ...
    private Material _secundMaterial;
    ...
    {
        _secundMaterial = mat;
        _secundMaterial.mainTexture = Resources.Load(texturePath, typeof(Texture2D)) as Texture2D;
    }
    ...
    {
        gameObject.GetComponent<Renderer>().material = _secundMaterial;
    }
